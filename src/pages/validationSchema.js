...
export const AddmsionSchema = Yup.object({
  ...
  firstInstallment: Yup.string().required('Feld is required'),
  firstInstallmentDate: Yup.string().required('Feld is required'),
  secondInstallment: Yup.string().required('Feld is required'),
  secondInstallmentDate: Yup.string().required('Feld is required'),
  thirdInstallment: Yup.string().required('Feld is required'),
  ...
  FeePackege: Yup.string().required('Fee Packege is required'),
  FullFee: Yup.string().required('Full Fee is required'),
  ...
  DegreeMarks: Yup.string().required('Degree Marks is required'),
...
export const RegisterQuerySchema = Yup.object({
  ...
  Phone: Yup.string().length(11, 'Invalid phone number').required('Phone Number By is Required'),
...
export const RegisterStudentSlip = Yup.object({
  ...
  RecievedAmmount: Yup.string().required('RecievedAmmount is Required'),
